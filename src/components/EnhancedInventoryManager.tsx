...
const EnhancedInventoryManager: React.FC<EnhancedInventoryManagerProps> = ({
  brandId,
  onPartCreated,
  onPartUpdated
}) => {
  ...
  // Individual field handlers with stable references and proper value handling
  const fieldHandlers = useMemo(() => ({
    code: (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    partNumber: (e: React.ChangeEvent<HTMLInputElement>) => {
      handleFormFieldChange('partNumber', e.target.value);
    },
    brandModel: (e: React.ChangeEvent<HTMLInputElement>) => {
      handleFormFieldChange('brandModel', e.target.value);
    },
    category: (value: string) => handleFormFieldChange('category', value),
    subCategory: (e: React.ChangeEvent<HTMLInputElement>) => {
      handleFormFieldChange('subCategory', e.target.value);
    },
    material: (e: React.ChangeEvent<HTMLInputElement>) => {
      handleFormFieldChange('material', e.target.value);
    },
    compatibility: (e: React.ChangeEvent<HTMLInputElement>) => {
      handleFormFieldChange('compatibility', e.target.value);
    },
    length: (e: React.ChangeEvent<HTMLInputElement>) => {
      const value = e.target.value;
      handleFormFieldChange('length', value === '' ? 0 : parseFloat(value) || 0);
    },
    breadth: (e: React.ChangeEvent<HTMLInputElement>) => {
      const value = e.target.value;
      handleFormFieldChange('breadth', value === '' ? 0 : parseFloat(value) || 0);
    },
    height: (e: React.ChangeEvent<HTMLInputElement>) => {
      const value = e.target.value;
      handleFormFieldChange('height', value === '' ? 0 : parseFloat(value) || 0);
    },
    weight: (e: React.ChangeEvent<HTMLInputElement>) => {
      const value = e.target.value;
      handleFormFieldChange('weight', value === '' ? 0 : parseFloat(value) || 0);
    },
    warranty: (e: React.ChangeEvent<HTMLInputElement>) => {
      const value = e.target.value;
      handleFormFieldChange('warranty', value === '' ? 0 : parseInt(value) || 0);
    },
    specifications: (e: React.ChangeEvent<HTMLTextAreaElement>) => {
      handleFormFieldChange('specifications', e.target.value);
    },
    tags: (e: React.ChangeEvent<HTMLTextAreaElement>) => {
      handleFormFieldChange('tags', e.target.value);
    },
    costPrice: (e: React.ChangeEvent<HTMLInputElement>) => {
      const value = e.target.value;
      handleFormFieldChange('costPrice', value === '' ? 0 : parseFloat(value) || 0);
    },
    price: (e: React.ChangeEvent<HTMLInputElement>) => {
      const value = e.target.value;
      handleFormFieldChange('price', value === '' ? 0 : parseFloat(value) || 0);
    },
    sellingPrice: (e: React.ChangeEvent<HTMLInputElement>) => {
      const value = e.target.value;
      handleFormFieldChange('sellingPrice', value === '' ? 0 : parseFloat(value) || 0);
    },
    stockQuantity: (e: React.ChangeEvent<HTMLInputElement>) => {
      const value = e.target.value;
      handleFormFieldChange('stockQuantity', value === '' ? 0 : parseInt(value) || 0);
    },
    minStockLevel: (e: React.ChangeEvent<HTMLInputElement>) => {
      const value = e.target.value;
      handleFormFieldChange('minStockLevel', value === '' ? 5 : parseInt(value) || 5);
    },
    maxStockLevel: (e: React.ChangeEvent<HTMLInputElement>) => {
      const value = e.target.value;
      handleFormFieldChange('maxStockLevel', value === '' ? 100 : parseInt(value) || 100);
    },
    reorderPoint: (e: React.ChangeEvent<HTMLInputElement>) => {
      const value = e.target.value;
      handleFormFieldChange('reorderPoint', value === '' ? 10 : parseInt(value) || 10);
    },
    reorderQty: (e: React.ChangeEvent<HTMLInputElement>) => {
      const value = e.target.value;
      handleFormFieldChange('reorderQty', value === '' ? 50 : parseInt(value) || 50);
    },
    imageUrl: (e: React.ChangeEvent<HTMLInputElement>) => {
      handleFormFieldChange('imageUrl', e.target.value);
    },
    imageUrls: (e: React.ChangeEvent<HTMLTextAreaElement>) => {
      handleFormFieldChange('imageUrls', e.target.value);
    },
    technicalDrawings: (e: React.ChangeEvent<HTMLTextAreaElement>) => {
      handleFormFieldChange('technicalDrawings', e.target.value);
    },
    installationVideos: (e: React.ChangeEvent<HTMLTextAreaElement>) => {
      handleFormFieldChange('installationVideos', e.target.value);
    },
    diyVideoUrl: (e: React.ChangeEvent<HTMLInputElement>) => {
      handleFormFieldChange('diyVideoUrl', e.target.value);
    },
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center space-x-2">
            ...
            <span>Enhanced Inventory & Spare Catalog</span>
          </CardTitle>
          <CardDescription>
            Comprehensive inventory management with advanced features for parts catalog, stock tracking, and bulk operations
          </CardDescription>
        </CardHeader>
      </Card>
      ...
      <Dialog open={showEditDialog} onOpenChange={setShowEditDialog}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Update part information, pricing, and stock details
            </DialogDescription>
          </DialogHeader>
          {PartForm}
        </DialogContent>
      ...
      <Dialog open={showStockDialog} onOpenChange={setShowStockDialog}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Adjust stock levels and view stock movement history
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-6">
            <div className="grid grid-cols-2 gap-4">
